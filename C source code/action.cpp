...
void mute()
{
    SendMessage(hgWindow, WM_APPCOMMAND, 0x200eb0, APPCOMMAND_VOLUME_MUTE * 0x10000);
}

//增大音量
void soundUp()
{
    SendMessage(hgWindow, WM_APPCOMMAND, 0x30292, APPCOMMAND_VOLUME_UP * 0x10000);
}

//减小音量
void soundDown()
{
    SendMessage(hgWindow, WM_APPCOMMAND, 0x30292, APPCOMMAND_VOLUME_DOWN * 0x10000);
}
